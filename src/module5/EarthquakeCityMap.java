...
public class EarthquakeCityMap extends PApplet {
	...
	public void mouseClicked()
	{
		...
		if(this.lastClicked!=null) {
			...
			findClickedMarker(cityMarkers);
			if(lastClicked!=null) {
				hideEverythingForCity();
			}
			else {
				findClickedMarker(quakeMarkers);
				if(lastClicked!=null) {
					hideEverythingForQuake();
				}
			}
		}
	}
	
	public void findClickedMarker(List<Marker> markers) {
		for(Marker m: markers) {
	...
	public void hideEverythingForQuake() {
		double dist = ((EarthquakeMarker)lastClicked).threatCircle();
		for(Marker m: cityMarkers) {
			if(m.getDistanceTo(lastClicked.getLocation()) > dist) {
				m.setHidden(true);
			}
	...
	public void hideEverythingForCity() {
		for(Marker m: quakeMarkers) {
